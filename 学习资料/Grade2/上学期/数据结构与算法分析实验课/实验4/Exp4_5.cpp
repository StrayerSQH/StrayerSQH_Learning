...
int main()
{
    ...
    for (int i = 0; i < 1; i++)
    {
        ...
        {
            storeCurrentChild.AddCourse(eachCourseInformationGeneralList.GetCourseInformationInGeneralList(qListCurrent->courseTypeId)->childnext);
