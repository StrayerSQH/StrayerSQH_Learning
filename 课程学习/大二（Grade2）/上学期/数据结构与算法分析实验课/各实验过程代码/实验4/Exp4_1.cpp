...
int main()
{
	...
	while (getline(courseFileName_csv, courseInformation))
	{
        ...
        eachCourseInformationGeneralList.AddCourseInEachType(tmpCourseInformation);
	}

    CourseInformation* test =  eachCourseInformationGeneralList.GetCourseInformationInGeneralList(1);
    cout << test->courseName << test->courseId;
